...
struct SensorCoating
{
  ...
  /**
   * \brief Average azimuth angle quality for MIMO angles valid
   * \note  TODO
   */
  ...
  float mdPhiIndcr;
  /**
   * \brief High elevation quality share valid
   * \note  TODO
   */
  ...
  float nRefIndcr;
  /**
   * \brief Number of valid reflections valid
   * \note  TODO
   */
...
struct LocAttributes_Packet
{
  ...
  std::array<uint8_t, 26> reserved_packet;   // 0xFF (all 26 Bytes)
} __attribute__((packed));
