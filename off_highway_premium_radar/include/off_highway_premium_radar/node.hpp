...
private:
  ...
  // Parameters
  //! Host interface
  std::string host_interface_{"enp1s0.2"};
  //! Host port
  uint16_t host_port_{0x76C5};
  //! Multicast IP
  std::string multicast_ip_{"FF14::4:4"};
  //! Sensor IP
  std::string sensor_ip_{"FD53:7CB8:383:2::56"};
  //! Sensor port
  uint16_t sensor_port_{0x76C5};
