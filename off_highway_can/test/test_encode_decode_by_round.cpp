...
INSTANTIATE_TEST_SUITE_P(
  ...
  EncodeByRoundTest,
  testing::Values(
    std::pair(Signal{0, 12, false, true, 1.0, 0.0, 0.0, 0.0, -50.6}, static_cast<uint64_t>(-51)),
    std::pair(Signal{0, 12, false, true, 1.0, 0.0, 0.0, 0.0, -50.5}, static_cast<uint64_t>(-51)),
    std::pair(Signal{0, 12, false, true, 1.0, 0.0, 0.0, 0.0, -50.4}, static_cast<uint64_t>(-50)),
    std::pair(Signal{0, 12, false, true, 1.5, 0.0, 0.0, 0.0, -15.0}, static_cast<uint64_t>(-10)),
    std::pair(Signal{0, 12, false, true, 1.5, 0.0, 0.0, 0.0, -20.1}, static_cast<uint64_t>(-13)),
    std::pair(Signal{0, 12, false, true, 1.5, 0.0, 0.0, 0.0, -10.7}, static_cast<uint64_t>(-7)),
    std::pair(Signal{0, 12, false, true, 0.1, 0.0, 0.0, 0.0, 2.94}, 29),
    std::pair(Signal{0, 12, false, true, 0.1, 0.0, 0.0, 0.0, 2.95}, 30),
    std::pair(Signal{0, 12, false, true, 0.1, 0.0, 0.0, 0.0, 2.96}, 30),
    std::pair(Signal{0, 12, false, false, 2.0, 0.0, 0.0, 0.0, 105.0}, 53),
    std::pair(Signal{0, 12, false, false, 2.0, 0.0, 0.0, 0.0, 106.0}, 53),
    std::pair(Signal{0, 12, false, false, 2.0, 0.0, 0.0, 0.0, 107.0}, 54),
    std::pair(Signal{0, 32, false, false, 0.0001, 0.0, 0.0, 0.0, 105.00004}, 1050000),
    std::pair(Signal{0, 32, false, false, 0.0001, 0.0, 0.0, 0.0, 106.00005}, 1060001),
    std::pair(Signal{0, 32, false, false, 0.0001, 0.0, 0.0, 0.0, 107.00006}, 1070001),
    std::pair(Signal{0, 32, false, false, 0.1, 0.0, 0.0, 0.0, 0.94}, 9),
    std::pair(Signal{0, 32, false, false, 0.1, 0.0, 0.0, 0.0, 0.96}, 10)
  )
);
