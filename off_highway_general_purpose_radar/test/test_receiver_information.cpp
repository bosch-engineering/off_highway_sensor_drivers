...
{
public:
  explicit InfoPublisher(off_highway_general_purpose_radar_msgs::msg::Information information)
  : Node("off_highway_general_purpose_radar_info_pub")
  {
...
public:
  InfoSubscriber()
  : Node("off_highway_general_purpose_radar_info_sub")
  {
    subscriber_ =
      this->create_subscription<off_highway_general_purpose_radar_msgs::msg::Information>(
      "info", 1,
      std::bind(&InfoSubscriber::info_callback, this, std::placeholders::_1));
  }

  off_highway_general_purpose_radar_msgs::msg::Information get_info()
  {
    return received_info_;
  }

private:
  void info_callback(const off_highway_general_purpose_radar_msgs::msg::Information msg)
  {
    received_info_ = msg;
  }
  rclcpp::Subscription<off_highway_general_purpose_radar_msgs::msg::Information>::SharedPtr
    subscriber_;
  off_highway_general_purpose_radar_msgs::msg::Information received_info_;
};  // InfoSubscriber
...
protected:
  ...
  void publish_info(off_highway_general_purpose_radar_msgs::msg::Information information);
  off_highway_general_purpose_radar_msgs::msg::Information get_info();
  void verify_info(
    off_highway_general_purpose_radar_msgs::msg::Information ref_info,
    off_highway_general_purpose_radar_msgs::msg::Information sub_info);
...
void TestRadarReceiver::publish_info(
  off_highway_general_purpose_radar_msgs::msg::Information information)
{
  info_publisher_ = std::make_shared<InfoPublisher>(information);
  wait_some(500ms);
}

off_highway_general_purpose_radar_msgs::msg::Information TestRadarReceiver::get_info()
{
...
TEST_F(TestRadarReceiver, testInfoZeroValues) {
  // Set all values to 0
  off_highway_general_purpose_radar_msgs::msg::Information test_information;
